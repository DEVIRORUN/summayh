...
// const ALL_SCHOOLS: School[] = [...schoolsData.edu_ng, ...schoolsData];
...
// components/atoms/EmailInput.tsx
...
export function EmailInput({ value, onChange, error, onErrorChange }: EmailInputProps) {
    return (
