  ...
  const mockGigs = [
    {
      ...
      seller: { avatar: "https://pravatar.cc", name: "David A.", isOnline: true },
    ...
    },
    {
      ...
      seller: { avatar: "https://pravatar.cc", name: "Sarah K.", isOnline: false },
      tags: ["copywriting"],
      isFavorited: true,
    },
    {
      ...
      seller: { avatar: "https://pravatar.cc", name: "Alex R.", isOnline: true },
    ...
    },
    {
      ...
      seller: { avatar: "https://pravatar.cc", name: "John M.", isOnline: true },
      tags: ["database"],
      isFavorited: false,
    },
    {
      ...
      // Using an image fallback here because standard GigCards expect static image thumbs rather than background mp4 play loops
      thumbnail: "https://hsfrsqsscahuvkakghab.supabase.co/storage/v1/object/public/SUMMAYH/gig-3.jpeg", 
      price: 6000,
      deliveryTime: "1 day",
      rating: { avgRating: 4.6, reviewCount: 12 },
      seller: { avatar: "https://pravatar.cc", name: "Elena V.", isOnline: false },
      tags: ["marketing"],
      isFavorited: false,
    },
  ];
    ...
    return (
    /* 🌟 FIXED: Swapped 'w-[75%]' for standard width max-caps, and added overflow-hidden to the master shell */
    <div className="w-full max-w-[75%] py-5 bg-background mx-auto px-6 rounded-lg overflow-hidden border shadow-sm">
        ...
        {/* Clean, unclipped content viewport shell */}
