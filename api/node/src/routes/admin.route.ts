 ...
 */
router.get("/disputes", isAdmin, AdminController.listDisputes);
 ...
 */
router.post("/users/:userId/verify", isAdmin, AdminController.verifyUser);
 ...
 *         description: Target user not found.
 */
router.post("/users/:userId/suspend", isAdmin, AdminController.suspendUser);
