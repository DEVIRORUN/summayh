 ...
 */
router.post("/", auth_1.protectRoute, dispute_controller_1.DisputeController.openDispute);
/**
 * @openapi
 ...
 *         description: Server error
 */
router.get("/:disputeId", auth_1.protectRoute, dispute_controller_1.DisputeController.getDispute);
/**
 * @openapi
 ...
 *         description: Server error
 */
router.post("/:disputeId/evidence", auth_1.protectRoute, dispute_controller_1.DisputeController.submitEvidence);
/**
 * @openapi
 ...
 *         description: Server error
 */
router.post("/:disputeId/resolve", auth_1.protectRoute, dispute_controller_1.DisputeController.resolveDispute);
