...
const termii_controller_1 = require("../controllers/termii.controller");
 ...
 */
router.post("/send", auth_1.protectRoute, termii_controller_1.TermiiController.sendOtp);
/**
 * @openapi
 * /api/otp/verify:
 *   post:
 ...
 */
router.post("/verify", auth_1.protectRoute, termii_controller_1.TermiiController.verifyOtp);
/**
 * @openapi
 ...
 */
router.post("/notify/order-placed", auth_1.protectRoute, termii_controller_1.TermiiController.notifyOrderPlaced);
/**
 * @openapi
 ...
 *         description: Failed to notify buyer
 */
router.post("/notify/order-completed", auth_1.protectRoute, termii_controller_1.TermiiController.notifyOrderCompleted);
/**
 * @openapi
 ...
 */
router.post("/notify/payout-sent", auth_1.protectRoute, termii_controller_1.TermiiController.notifyPayoutSent);
