...
const prisma_1 = require("../../utils/prisma"); // adjust to your actual client import
const scoreCalculator_1 = require("./scoreCalculator");
const prisma_2 = require("../../../generated/prisma"); // adjust path as needed
 ...
 */
async function recalculateScore(gigId) {
    ...
    if (!gig)
        throw new Error(`Gig not found for score recalculation: ${gigId}`);
    ...
    const completedOrders = gig.orders.filter(o => o.status === prisma_2.OrderStatus.COMPLETED).length;
    ...
    const { baseRankingScore } = (0, scoreCalculator_1.calculateRankingScore)({
        trustScore,
        completionRate,
        ctr,
        conversionRate,
    ...
    await prisma_1.prisma.gig.update({
        where: { id: gigId },
        data: {
            baseRankingScore,
