...
exports.calculateRankingScore = calculateRankingScore;
const prisma_1 = require("../../../generated/prisma"); // adjust path to match your actual generated client import
const WEIGHTS = {
    trust: 0.40,
    completion: 0.25,
    ctr: 0.20,
 ...
 */
function calculateRankingScore(inputs) {
    ...
    let weightedFloat = (normalizedTrust * WEIGHTS.trust) +
    ...
    if (inputs.statusFlag === prisma_1.GigStatusFlag.SHADOWBAN) {
        weightedFloat = 0;
    }
    else if (inputs.statusFlag === prisma_1.GigStatusFlag.WARNING) {
        weightedFloat *= 0.5;
    }
    ...
    if (inputs.isRookiePeriod && inputs.statusFlag !== prisma_1.GigStatusFlag.SHADOWBAN) {
